...
class Blockchain{
    constructor(){
        ...
        this.miningReward = Math.floor(Math.random() * 50) + 1;
    }
...
myCoin.minePendingTransactions('name-address');

console.log('Balance of name is ' + myCoin.getBalanceOfAddress('name-address') + ' MyCoins.\n');
...
amount.question("Please specify how many blocks would you like to mine? ", (answer) => {
    console.log(`Starting the process of mining ${answer} blocks of MyCoins . . .`);
